...
require (
	github.com/bamboo-services/bamboo-base-go/common v1.0.6
	github.com/bamboo-services/bamboo-base-go/defined v1.0.6
	github.com/bamboo-services/bamboo-base-go/plugins/email v1.0.6
