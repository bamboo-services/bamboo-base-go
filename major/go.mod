module github.com/bamboo-services/bamboo-base-go/major

go 1.25.11

require (
	github.com/bamboo-services/bamboo-base-go/common v1.0.3
	github.com/bamboo-services/bamboo-base-go/defined v1.0.3
	github.com/bamboo-services/bamboo-base-go/plugins/email v1.0.3
